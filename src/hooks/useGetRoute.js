  ...
  const getRoute = useCallback(
    (city, dataMapper = (val) => val, searchKey, routeLen) =>
      getTDXAxios().then((axios) =>
        apiAdapter({
          api: axios.get(
            ` https://tdx.transportdata.tw/api/basic/v2/Cycling/Shape/City/${stopCityMaptoRouteCity(
              city
            )}?$top=30&$filter=RoadSectionStart ne null and RoadSectionEnd ne null and Direction ne null ${
